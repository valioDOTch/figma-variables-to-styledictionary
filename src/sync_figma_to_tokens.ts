...
async function main() {
  console.log("Object.keys(process):") console.log(Object.keys(process));
  console.log("Object.keys(process.env):"); console.log(Object.keys(process.env));
  console.log("Object.keys(secrets):"); console.log(Object.keys(secrets));
